...
{
    public class iTextSharpPDFPainter : FilePainter
    {
        protected Document _itextDocument;

        public iTextSharpPDFPainter() : base(new iTextSharpAdapter())
        {
        }

        public override void Drawing(FileContext context)
        {
            this._itextDocument = base._adapter.DocumentMappingTo<Document>(context.Document);
            PdfWriter.GetInstance(this._itextDocument, context.Stream);
